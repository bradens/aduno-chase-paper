...
\textit{Does the use of real-time collaborative tools for task management in the design phase lead to beware clarification requests in the following stages of development?}
